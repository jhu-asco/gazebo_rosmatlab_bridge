...
%%% Problem Setting %%%%
tf = 2;%Time to run the Controller for
x0  = [0;0;0;0.5;0;0]; %Posn(x,y),Angle, Body Velocity of car, steering angle position, steering angle velocity
S.xf = [2.5; 2; pi/2; 0.2];%Goal Posn(x,y),Angle, Body Velocity of car
